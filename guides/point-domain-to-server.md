...
title: "How to Point Your Domain Name to Your Cloud Server | Guides | bithost"
h1: "How to Point Your Domain Name to Your Cloud Server"
description: "To make your website accessible via a domain (e.g. yoursite.com instead of an IP address), you need to update your domain's DNS records. This guide explain..."
canonical: "https://bithost.io/guides/point-domain-to-server"
og_title: "How to Point Your Domain Name to Your Cloud Server - bithost Guide"
og_url: "https://bithost.io/guides/point-domain-to-server"
og_description: "To make your website accessible via a domain (e.g. yoursite.com instead of an IP address), you need to update your domain's DNS records. This guide explain..."
og_type: article
schema_type: HowTo
...
* Your server\'s **IPv4 address** (e.g. `123.45.67.89`) - found in your
  server dashboard
* Access to your **domain registrar** (e.g. Namecheap, GoDaddy,
  Cloudflare, Google Domains)

## Step 1: Find Your Server\'s IP Address

Log in to your server control panel and note the **IPv4 address** on
your server\'s overview page.
...
| `ERR_CONNECTION_REFUSED` | Domain resolves but server isn\'t serving - check Nginx is running |
